...
export default {
    setup(props) {
        ...
        const submit = () => {
            ...
            console.log('successData', successData.value)
            ...
            postData.transform((data) => ({
                ...
                .post(route('product.checkout.store', props.product.id), {
                    onSuccess: () => {
                    }
                });
        }
        ...
        const selectCategory = () => {
            ...
            const interval = setInterval(() => {
                ...
                if (product.value.category_product.child) {
                    product.value.category_product.child.forEach((item, index) => {
                        let option = {
                            value: item,
                            label: item.name
                        };
        ...
        const selectChildCategory = () => {
            ...
            const interval = setInterval(() => {
                optionGrandChildCategory.value = []
                if (product.value.childCategory.child) {
                    product.value.childCategory.child.forEach((item, index) => {
                        let option = {
                            value: item,
                            label: item.name
                        };
...
<template>
    <Layout>
        ...
        <BRow>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div nav-class="row mb-3">
                                            ...
                                            <div class="col-12" title="COD"
                                                ...
                                                <div class="ckeditor-classic">
                                                    <ckeditor v-model="successData.bodyText.cod" :editor="editor">
                                                    </ckeditor>
                                                </div>
                                            </div>
                                            <div class="col-12" title="Payment"
                                                ...
                                                <div class="ckeditor-classic">
                                                    <ckeditor v-model="successData.bodyText.payment" :editor="editor">
                                                    </ckeditor>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <BCardBody class="pt-0 pb-0 border-bottom border-success">
                                    <div class="row">
                                        <div class="col-12 p-2">
                                            ...
                                            <div class="mb-3">
                                                <h5 class="text-center text-success fw-bold fs-3">Rp{{ product.normal_price
                                                }}
                                                </h5>
                                            </div>
            ...
            <template v-if="successData.type == 'redirect_wa'">
                <BCol lg="6" v-if="page == 'success'">
