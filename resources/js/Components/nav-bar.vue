      ...
      <div class="navbar-header">
        <div class="d-flex">
          ...
          <div class="navbar-brand-box horizontal-logo">
            ...
            <span class="logo-sm">
              <img src="@assets/images/logo-white.png" class="img-fluid" width="100" alt="" />
            </span>
            <span class="logo-lg">
              <img src="@assets/images/logo-white.png" class="img-fluid" width="100" alt="" />
            </span>
          ...
          <BDropdown variant="link" class="ms-sm-3 header-item topbar-user" toggle-class="rounded-circle arrow-none"
            ...
            <template #button-content>
              <span class="d-flex align-items-center">
                <img :src="user.image" class="rounded-circle header-profile-user">
                <span class="text-start ms-xl-2">
                  <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ user.name }}</span>
                  <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"
                    v-if="user.user_store.is_owner == true">Owner</span>
                  <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"
                    v-if="user.user_store.is_owner == false">{{ user.user_store.role }}</span>
                </span>
              </span>
            </template>
            <!-- <h6 class="dropdown-header">Welcome!</h6> -->
            <Link href="/profile" class="dropdown-item"><i
            ...
            <Link class="dropdown-item" href="/team" v-if="user.permission.team.read == true">
            <i class="mdi mdi-table-account text-muted fs-16 align-middle me-1"></i>
            <span class="align-middle"> Team Management</span>
            </Link>
